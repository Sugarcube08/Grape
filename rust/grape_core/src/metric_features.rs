...
use crate::{
    ...
    metrics::{
        AlgorithmRunResult, GRAPE_HRV_V0_ID, GRAPE_HRV_V0_VERSION, HrvInput, HrvOutput,
        RecoveryInput, RecoveryScoreOutput, SleepInput, SleepScoreOutput, StrainInput,
        StrainScoreOutput, StressInput, StressScoreOutput, grape_hrv_v0, grape_recovery_v0,
        grape_sleep_v0, grape_strain_v0, grape_stress_v0,
    },
    protocol::{
        DataPacketBodySummary, I16SeriesSummary, ParsedPayload, decode_hex_with_whitespace,
    },
    store::{DecodedFrameRow, GrapeStore},
    validation_labels::{
...
pub const MOTION_FEATURE_REPORT_SCHEMA: &str = "grape.motion-feature-report.v1";
pub const HEART_RATE_FEATURE_REPORT_SCHEMA: &str = "grape.heart-rate-feature-report.v1";
pub const HRV_FEATURE_REPORT_SCHEMA: &str = "grape.hrv-feature-report.v1";
pub const HRV_CAPTURE_VALIDATION_REPORT_SCHEMA: &str = "grape.hrv-capture-validation-report.v1";
pub const VITAL_EVENT_FEATURE_REPORT_SCHEMA: &str = "grape.vital-event-feature-report.v1";
pub const RESPIRATORY_RATE_CAPTURE_VALIDATION_REPORT_SCHEMA: &str =
    "grape.respiratory-rate-capture-validation-report.v1";
pub const OXYGEN_SATURATION_CAPTURE_VALIDATION_REPORT_SCHEMA: &str =
    "grape.oxygen-saturation-capture-validation-report.v1";
pub const TEMPERATURE_CAPTURE_VALIDATION_REPORT_SCHEMA: &str =
    "grape.temperature-capture-validation-report.v1";
pub const RECOVERY_SENSOR_DISCOVERY_REPORT_SCHEMA: &str =
    "grape.recovery-sensor-discovery-report.v1";
pub const METRIC_WINDOW_FEATURE_REPORT_SCHEMA: &str = "grape.metric-window-feature-report.v1";
pub const RESTING_HEART_RATE_FEATURE_REPORT_SCHEMA: &str =
    "grape.resting-heart-rate-feature-report.v1";
pub const SLEEP_FEATURE_SCORE_REPORT_SCHEMA: &str = "grape.sleep-feature-score-report.v1";
pub const RECOVERY_FEATURE_SCORE_REPORT_SCHEMA: &str = "grape.recovery-feature-score-report.v1";
pub const STRAIN_FEATURE_SCORE_REPORT_SCHEMA: &str = "grape.strain-feature-score-report.v1";
pub const STRESS_FEATURE_SCORE_REPORT_SCHEMA: &str = "grape.stress-feature-score-report.v1";
...
pub const GRAPE_RESPIRATORY_RATE_HISTORY_CANDIDATE_V0_ID: &str =
    "grape.respiratory_rate.history_candidate.v0";
pub const GRAPE_RESPIRATORY_RATE_HISTORY_CANDIDATE_V0_VERSION: &str = "0.1.0";
pub const GRAPE_OXYGEN_SATURATION_PACKET_CANDIDATE_V0_ID: &str =
    "grape.oxygen_saturation.packet_candidate.v0";
pub const GRAPE_OXYGEN_SATURATION_PACKET_CANDIDATE_V0_VERSION: &str = "0.1.0";
pub const GRAPE_SKIN_TEMPERATURE_HISTORY_CANDIDATE_V0_ID: &str =
    "grape.skin_temperature.history_candidate.v0";
pub const GRAPE_SKIN_TEMPERATURE_HISTORY_CANDIDATE_V0_VERSION: &str = "0.1.0";
...
) -> GrapeResult<MotionFeatureReport> {
...
pub fn run_motion_feature_report(
    ...
    Ok(MotionFeatureReport {
        ...
        generated_by: "grape-motion-feature-extractor".to_string(),
...
) -> GrapeResult<HeartRateFeatureReport> {
    let decoded_rows = store.decoded_frames_between(start, end)?;
    let correlation = run_capture_correlation_for_store(
        store,
        database_path,
...
pub fn run_heart_rate_feature_report(
    ...
    Ok(HeartRateFeatureReport {
        ...
        generated_by: "grape-heart-rate-feature-extractor".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        capture_correlation_pass: correlation.pass,
        candidate_frame_count,
...
) -> GrapeResult<VitalEventFeatureReport> {
    let decoded_rows = store.decoded_frames_between(start, end)?;
    let correlation = run_capture_correlation_for_store(
        store,
        database_path,
...
pub fn run_respiratory_rate_capture_validation_for_store(
...
) -> GrapeResult<RespiratoryRateCaptureValidationReport> {
    ...
    Ok(RespiratoryRateCaptureValidationReport {
        ...
        generated_by: "grape-respiratory-rate-capture-validator".to_string(),
        pass: issues.is_empty(),
        ...
        decoder_id: GRAPE_RESPIRATORY_RATE_HISTORY_CANDIDATE_V0_ID.to_string(),
        decoder_version: GRAPE_RESPIRATORY_RATE_HISTORY_CANDIDATE_V0_VERSION.to_string(),
...
pub fn run_oxygen_saturation_capture_validation_for_store(
...
) -> GrapeResult<OxygenSaturationCaptureValidationReport> {
    ...
    Ok(OxygenSaturationCaptureValidationReport {
        ...
        generated_by: "grape-oxygen-saturation-capture-validator".to_string(),
        pass: issues.is_empty(),
        database_path: database_path.to_string(),
        start_time: start.to_string(),
        end_time: end.to_string(),
        ...
        decoder_id: GRAPE_OXYGEN_SATURATION_PACKET_CANDIDATE_V0_ID.to_string(),
        decoder_version: GRAPE_OXYGEN_SATURATION_PACKET_CANDIDATE_V0_VERSION.to_string(),
...
pub fn run_temperature_capture_validation_for_store(
...
) -> GrapeResult<TemperatureCaptureValidationReport> {
    ...
    Ok(TemperatureCaptureValidationReport {
        ...
        generated_by: "grape-temperature-capture-validator".to_string(),
        pass: issues.is_empty(),
        database_path: database_path.to_string(),
        start_time: start.to_string(),
        end_time: end.to_string(),
        ...
        decoder_id: GRAPE_SKIN_TEMPERATURE_HISTORY_CANDIDATE_V0_ID.to_string(),
        decoder_version: GRAPE_SKIN_TEMPERATURE_HISTORY_CANDIDATE_V0_VERSION.to_string(),
        source_kind: "unavailable".to_string(),
...
pub fn run_vital_event_feature_report(
    ...
    Ok(VitalEventFeatureReport {
        ...
        generated_by: "grape-vital-event-feature-extractor".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        capture_correlation_pass: correlation.pass,
...
pub fn run_hrv_capture_validation_for_store(
...
) -> GrapeResult<HrvCaptureValidationReport> {
    ...
    Ok(HrvCaptureValidationReport {
        ...
        generated_by: "grape-hrv-capture-validator".to_string(),
        pass: issues.is_empty(),
        database_path: database_path.to_string(),
        start_time: start.to_string(),
        end_time: end.to_string(),
        ...
        algorithm_id: GRAPE_HRV_V0_ID.to_string(),
        algorithm_version: GRAPE_HRV_V0_VERSION.to_string(),
...
pub fn run_hrv_feature_report(
    ...
    let score_result = hrv_input.as_ref().map(grape_hrv_v0);
    if score_result
        .as_ref()
    ...
    Ok(HrvFeatureReport {
        ...
        generated_by: "grape-hrv-feature-extractor".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        capture_correlation_pass: correlation.pass,
        start_time: start.to_string(),
...
pub fn run_recovery_sensor_discovery_report_for_store(
...
) -> GrapeResult<RecoverySensorDiscoveryReport> {
    let hrv_report = run_hrv_feature_report_for_store(
        store,
        database_path,
        start,
    ...
    Ok(RecoverySensorDiscoveryReport {
        ...
        generated_by: "grape-recovery-sensor-discovery-gate".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
) -> GrapeResult<MetricWindowFeatureReport> {
    let decoded_rows = store.decoded_frames_between(start, end)?;
    let correlation = run_capture_correlation_for_store(
        store,
        database_path,
...
pub fn run_metric_window_feature_report(
    ...
    Ok(MetricWindowFeatureReport {
        ...
        generated_by: "grape-metric-window-feature-aggregator".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
) -> GrapeResult<RestingHeartRateFeatureReport> {
    let decoded_rows = store.decoded_frames_between(start, end)?;
    let correlation = run_capture_correlation_for_store(
        store,
        database_path,
...
pub fn run_resting_heart_rate_feature_report(
    ...
    Ok(RestingHeartRateFeatureReport {
        ...
        generated_by: "grape-resting-heart-rate-feature-extractor".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        require_baseline: options.require_baseline,
        baseline_min_days: options.baseline_min_days,
...
pub fn run_sleep_feature_score_report_for_store(
...
) -> GrapeResult<SleepFeatureScoreReport> {
    ...
    if let Some(window) = &sleep_window {
        ...
        let result = grape_sleep_v0(&input);
    ...
    Ok(SleepFeatureScoreReport {
        ...
        generated_by: "grape-sleep-feature-score-builder".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
pub fn run_recovery_feature_score_report_for_store(
...
) -> GrapeResult<RecoveryFeatureScoreReport> {
    let hrv_report = run_hrv_feature_report_for_store(
        store,
        database_path,
        hrv_start,
    ...
    if let (
        ...
        let mut result = grape_recovery_v0(&input);
        result
            .quality_flags
    ...
    Ok(RecoveryFeatureScoreReport {
        ...
        generated_by: "grape-recovery-feature-score-builder".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
pub fn run_strain_feature_score_report_for_store(
...
) -> GrapeResult<StrainFeatureScoreReport> {
    let resting_report = run_resting_heart_rate_feature_report_for_store(
        store,
        database_path,
        resting_start,
        ...
        if let Some(max_hr_bpm) = max_hr_bpm {
            if max_hr_bpm <= resting_hr_bpm {
                ...
                if let Some(window) = &report.window {
                    ...
                    let mut result = grape_strain_v0(&input);
    ...
    Ok(StrainFeatureScoreReport {
        ...
        generated_by: "grape-strain-feature-score-builder".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
pub fn run_stress_feature_score_report_for_store(
...
) -> GrapeResult<StressFeatureScoreReport> {
    let feature_options = MotionFeatureOptions {
        min_owned_captures_per_summary: options.min_owned_captures_per_summary,
        require_trusted_evidence: options.require_trusted_evidence,
    };
    ...
    if let (
        ...
        let result = grape_stress_v0(&input);
        if !result.errors.is_empty() {
    ...
    Ok(StressFeatureScoreReport {
        ...
        generated_by: "grape-stress-feature-score-builder".to_string(),
        pass: issues.is_empty(),
        require_trusted_evidence: options.require_trusted_evidence,
        start_time: start.to_string(),
        end_time: end.to_string(),
...
fn validate_hrv_validation_options(options: &HrvCaptureValidationOptions) -> GrapeResult<()> {
    if !options.tolerance_ms.is_finite() || options.tolerance_ms < 0.0 {
        return Err(GrapeError::message("tolerance_ms must be nonnegative"));
    }
...
fn validate_respiratory_rate_validation_options(
    ...
    if !options.tolerance_rpm.is_finite() || options.tolerance_rpm < 0.0 {
        return Err(GrapeError::message("tolerance_rpm must be nonnegative"));
    }
...
fn validate_oxygen_saturation_validation_options(
    ...
    if !options.tolerance_percent.is_finite() || options.tolerance_percent < 0.0 {
        return Err(GrapeError::message("tolerance_percent must be nonnegative"));
    }
...
fn validate_temperature_validation_options(
    ...
    if !options.tolerance_c.is_finite() || options.tolerance_c < 0.0 {
        return Err(GrapeError::message("tolerance_c must be nonnegative"));
    }
...
fn motion_plan_from_row(row: &DecodedFrameRow) -> GrapeResult<Option<MotionPlan>> {
...
fn heart_rate_plan_from_row(row: &DecodedFrameRow) -> GrapeResult<Option<HeartRatePlan>> {
    let parsed_payload = parsed_payload_from_row(row)?;
    let Some(ParsedPayload::DataPacket {
        timestamp_seconds,
        timestamp_subseconds,
...
fn parsed_payload_from_row(row: &DecodedFrameRow) -> GrapeResult<Option<ParsedPayload>> {
...
fn hrv_plan_from_row(row: &DecodedFrameRow) -> GrapeResult<Option<HrvPlan>> {
    let parsed_payload: Option<ParsedPayload> = serde_json::from_str(&row.parsed_payload_json)
        .map_err(|error| {
            GrapeError::message(format!(
                "{} parsed_payload_json invalid: {error}",
...
) -> GrapeResult<Option<MotionFeature>> {
    let mut quality_flags = BTreeSet::new();
...
fn heart_rate_feature_from_plan(
    ...
    plan: HeartRatePlan,
    trusted_frames: &BTreeMap<String, bool>,
) -> GrapeResult<Option<HeartRateFeature>> {
    let mut quality_flags = BTreeSet::new();
...
fn skin_temperature_feature_from_plan(
    ...
    trusted_frames: &BTreeMap<String, bool>,
) -> GrapeResult<Option<SkinTemperatureFeature>> {
    let payload = decode_hex_with_whitespace(&row.payload_hex)?;
...
fn respiratory_rate_feature_from_plan(
    ...
    trusted_frames: &BTreeMap<String, bool>,
) -> GrapeResult<Option<RespiratoryRateFeature>> {
    let payload = decode_hex_with_whitespace(&row.payload_hex)?;
    let Some(raw_bytes) = payload.get(plan.raw_absolute_offset..plan.raw_absolute_offset + 2)
    else {
        return Ok(None);
...
fn aggregate_metric_window(
    ...
    options: MetricWindowFeatureOptions,
) -> GrapeResult<MetricWindowFeature> {
    let mut quality_flags = BTreeSet::new();
...
fn sleep_window_feature(
    ...
    Some(SleepWindowFeature {
        ...
        disturbance_count,
        stage_model_version: "grape_sleep_stage_heuristic_v1_transition_smoothed".to_string(),
        stage_segments,
        stage_minutes,
        ...
        provenance: json!({
            ...
            "disturbance_motion_threshold_0_to_1": options.disturbance_motion_threshold_0_to_1,
            "target_midpoint_minutes_since_midnight": options.target_midpoint_minutes_since_midnight,
            "stage_model_version": "grape_sleep_stage_heuristic_v1_transition_smoothed",
...
fn parse_warnings(row: &DecodedFrameRow) -> GrapeResult<Vec<String>> {
    serde_json::from_str(&row.warnings_json).map_err(|error| {
        GrapeError::message(format!("{} warnings_json invalid: {error}", row.frame_id))
    })
}
