...
pub const HISTORICAL_SYNC_DRY_RUN_SCHEMA: &str = "grape.historical-sync-dry-run.v1";
pub const HISTORICAL_SYNC_DRY_RUN_REPORT_SCHEMA: &str = "grape.historical-sync-dry-run-report.v1";
pub const HISTORICAL_SYNC_PHYSICAL_VALIDATION_SCHEMA: &str =
    "grape.historical-sync-physical-validation.v1";
pub const HISTORICAL_SYNC_PHYSICAL_VALIDATION_REPORT_SCHEMA: &str =
    "grape.historical-sync-physical-validation-report.v1";
pub const HISTORICAL_SYNC_PHYSICAL_EVIDENCE_TEMPLATE_SCHEMA: &str =
    "grape.historical-sync-physical-evidence-template.v1";
...
pub fn historical_sync_physical_evidence_template(
    ...
    HistoricalSyncPhysicalEvidenceTemplate {
        ...
        generated_by: "grape-historical-sync-physical-validator".to_string(),
        generation,
...
fn finish_report(
    ...
    HistoricalSyncDryRunReport {
        ...
        generated_by: "grape-historical-sync-dry-run".to_string(),
        generation: input.generation,
...
fn issue_action(issue: &str) -> String {
    match issue {
        "unsupported schema grape.historical-sync-dry-run.v1" => {
            "Use grape.historical-sync-dry-run.v1 input before planning historical sync."
                .to_string()
        }
        "device_disconnected" => {
...
fn physical_validation_issue_action(issue: &str) -> String {
    match issue {
        ...
        value if value.starts_with("unsupported schema ") => {
            "Use grape.historical-sync-physical-validation.v1 for physical evidence bundles.".to_string()
        }
