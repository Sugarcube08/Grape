...
pub const GRAPE_HRV_V0_ID: &str = "grape.hrv.v0";
pub const GRAPE_HRV_V0_VERSION: &str = "0.1.0";
pub const GRAPE_SLEEP_V0_ID: &str = "grape.sleep.v0";
pub const GRAPE_SLEEP_V0_VERSION: &str = "0.1.0";
pub const GRAPE_SLEEP_V1_ID: &str = "grape.sleep.v1";
pub const GRAPE_SLEEP_V1_VERSION: &str = "0.1.0";
pub const GRAPE_STRAIN_V0_ID: &str = "grape.strain.v0";
pub const GRAPE_STRAIN_V0_VERSION: &str = "0.1.0";
pub const GRAPE_RECOVERY_V0_ID: &str = "grape.recovery.v0";
pub const GRAPE_RECOVERY_V0_VERSION: &str = "0.1.0";
pub const GRAPE_STRESS_V0_ID: &str = "grape.stress.v0";
pub const GRAPE_STRESS_V0_VERSION: &str = "0.1.0";
...
pub struct SleepModelStatusInput {
    ...
    #[serde(default)]
    pub trusted_grape_sleep_nights: u32,
    #[serde(default)]
...
pub struct SleepModelStatusReport {
    ...
    #[serde(default)]
    pub nights_until_grape_training: u32,
...
pub fn built_in_default_algorithm_preferences() -> Vec<AlgorithmPreferenceRecord> {
    vec![
        default_algorithm_preference("hrv", GRAPE_HRV_V0_ID, GRAPE_HRV_V0_VERSION),
        default_algorithm_preference("sleep", GRAPE_SLEEP_V0_ID, GRAPE_SLEEP_V0_VERSION),
        default_algorithm_preference("strain", GRAPE_STRAIN_V0_ID, GRAPE_STRAIN_V0_VERSION),
        default_algorithm_preference("recovery", GRAPE_RECOVERY_V0_ID, GRAPE_RECOVERY_V0_VERSION),
        default_algorithm_preference("stress", GRAPE_STRESS_V0_ID, GRAPE_STRESS_V0_VERSION),
    ]
}
...
fn hrv_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        ...
        version: GRAPE_HRV_V0_VERSION.to_string(),
        metric_family: "hrv".to_string(),
        display_name: "Grape HRV v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.hrv-input.v1".to_string(),
        output_schema: "grape.hrv-output.v1".to_string(),
...
fn sleep_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: GRAPE_SLEEP_V0_ID.to_string(),
        version: GRAPE_SLEEP_V0_VERSION.to_string(),
        metric_family: "sleep".to_string(),
        display_name: "Grape Sleep v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.sleep-input.v1".to_string(),
        output_schema: "grape.sleep-output.v1".to_string(),
        input_requirements_json: json!({
...
fn sleep_v1_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: GRAPE_SLEEP_V1_ID.to_string(),
        version: GRAPE_SLEEP_V1_VERSION.to_string(),
        metric_family: "sleep".to_string(),
        display_name: "Grape Sleep v1".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.sleep-v1-input.v1".to_string(),
        output_schema: "grape.sleep-v1-output.v1".to_string(),
        input_requirements_json: json!({
        ...
        quality_gates_json: json!([
            ...
            "trained_requires_holdout_validation_and_grape_packet_derived_nights"
        ])
        .to_string(),
        status: "experimental".to_string(),
    }
...
fn strain_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: GRAPE_STRAIN_V0_ID.to_string(),
        version: GRAPE_STRAIN_V0_VERSION.to_string(),
        metric_family: "strain".to_string(),
        display_name: "Grape Strain v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.strain-input.v1".to_string(),
        output_schema: "grape.strain-output.v1".to_string(),
        input_requirements_json: json!({
...
fn recovery_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: GRAPE_RECOVERY_V0_ID.to_string(),
        version: GRAPE_RECOVERY_V0_VERSION.to_string(),
        metric_family: "recovery".to_string(),
        display_name: "Grape Recovery v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.recovery-input.v1".to_string(),
        output_schema: "grape.recovery-output.v1".to_string(),
        input_requirements_json: json!({
...
fn stress_definition() -> AlgorithmDefinitionRecord {
    AlgorithmDefinitionRecord {
        algorithm_id: GRAPE_STRESS_V0_ID.to_string(),
        version: GRAPE_STRESS_V0_VERSION.to_string(),
        metric_family: "stress".to_string(),
        display_name: "Grape Stress v0".to_string(),
        implementation: "rust".to_string(),
        license: "UNLICENSED".to_string(),
        input_schema: "grape.stress-input.v1".to_string(),
        output_schema: "grape.stress-output.v1".to_string(),
        input_requirements_json: json!({
...
pub fn grape_hrv_v0(input: &HrvInput) -> AlgorithmRunResult<HrvOutput> {
    ...
    AlgorithmRunResult {
        ...
        provenance: json!({
            ...
            "expected_values_policy": "hand-derived-tests-and-versioned-grape-output"
        }),
    }
}

pub fn grape_sleep_v0(input: &SleepInput) -> AlgorithmRunResult<SleepScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(SleepScoreOutput {
            algorithm_id: GRAPE_SLEEP_V0_ID.to_string(),
            algorithm_version: GRAPE_SLEEP_V0_VERSION.to_string(),
...
pub fn grape_sleep_v1(input: &SleepV1Input) -> AlgorithmRunResult<SleepV1Output> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = match (errors.is_empty(), v0_result.output) {
        (true, Some(v0_output)) => {
            ...
            Some(SleepV1Output {
                algorithm_id: GRAPE_SLEEP_V1_ID.to_string(),
                algorithm_version: GRAPE_SLEEP_V1_VERSION.to_string(),
...
pub fn evaluate_sleep_model_status(input: &SleepModelStatusInput) -> SleepModelStatusReport {
    ...
    if !input.sleep_permission_granted && valid_sleep_nights == 0 {
        ...
        next_actions.push(
            "Grant sleep history access or complete one Grape packet-derived sleep night."
                .to_string(),
        );
        return sleep_model_status_report(
            SleepModelStatus::SetupNeeded,
            "Setup needed",
            "Grape needs sleep history access or one packet-derived night to begin learning.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.history_import_in_progress && nights_until_baseline > 0 {
        ...
        return sleep_model_status_report(
            ...
            "Importing history",
            "Grape is importing existing sleep history before building a baseline.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.timezone_or_schedule_shift_detected || input.repeated_low_confidence_nights {
        ...
        next_actions.push(
            "Collect several recent high-confidence nights so Grape can refresh the baseline."
                .to_string(),
        );
        return sleep_model_status_report(
            SleepModelStatus::NeedsRelearn,
            "Needs relearn",
            "Recent sleep patterns differ enough that Grape should refresh the personal model.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
        ...
        && valid_sleep_nights >= 7
    {
        ...
        return sleep_model_status_report(
            SleepModelStatus::NeedsRelearn,
            "Needs relearn",
            "The sleep baseline is stale because Grape has not seen a recent valid night.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.holdout_validation_passed
        && input.trusted_grape_sleep_nights >= 7
        ...
        && heart_rate_coverage_ok
    {
        return sleep_model_status_report(
            ...
            "Trained",
            "Grape has a passed personal sleep model for this algorithm version.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if valid_sleep_nights == 0 {
        ...
        return sleep_model_status_report(
            SleepModelStatus::SetupNeeded,
            "Setup needed",
            "Grape needs one valid sleep night to start learning.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.trusted_grape_sleep_nights >= 7
        && input.calibration_label_count >= 14
        && !input.holdout_validation_passed
    {
        ...
        return sleep_model_status_report(
            ...
            "Training",
            "Grape has enough sleep history for training, but holdout validation has not passed.",
            input,
            valid_sleep_nights,
            nights_until_baseline,
            nights_until_training,
    ...
    if input.trusted_grape_sleep_nights == 0 {
        next_actions.push(
            "Complete one Grape packet-derived sleep night before showing a final Sleep V1 score."
                .to_string(),
        );
    } else if input.trusted_grape_sleep_nights < 7 {
        let nights_until_grape_training = 7u32.saturating_sub(input.trusted_grape_sleep_nights);
        next_actions.push(format!(
            "Collect {nights_until_grape_training} more Grape packet-derived sleep night{} before training.",
            plural_suffix(nights_until_grape_training)
        ));
    ...
    sleep_model_status_report(
        ...
        "Baseline ready",
        "Grape has enough sleep history for personal schedule and debt baselines.",
        input,
        valid_sleep_nights,
        nights_until_baseline,
        nights_until_training,
...
pub fn grape_strain_v0(input: &StrainInput) -> AlgorithmRunResult<StrainScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(StrainScoreOutput {
            algorithm_id: GRAPE_STRAIN_V0_ID.to_string(),
            algorithm_version: GRAPE_STRAIN_V0_VERSION.to_string(),
...
pub fn grape_recovery_v0(input: &RecoveryInput) -> AlgorithmRunResult<RecoveryScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(RecoveryScoreOutput {
            algorithm_id: GRAPE_RECOVERY_V0_ID.to_string(),
            algorithm_version: GRAPE_RECOVERY_V0_VERSION.to_string(),
            score_0_to_100: component_sum(&components),
            components,
        })
    } else {
...
pub fn grape_stress_v0(input: &StressInput) -> AlgorithmRunResult<StressScoreOutput> {
    let mut quality_flags = Vec::new();
    let mut errors = Vec::new();
    ...
    let output = if errors.is_empty() {
        ...
        Some(StressScoreOutput {
            algorithm_id: GRAPE_STRESS_V0_ID.to_string(),
            algorithm_version: GRAPE_STRESS_V0_VERSION.to_string(),
            score_0_to_100: component_sum(&components),
...
pub fn algorithm_run_record<T: Serialize>(
...
) -> GrapeResult<AlgorithmRunRecord> {
    let output_json = serde_json::to_string(&result.output).map_err(|error| {
        GrapeError::message(format!("cannot serialize algorithm output: {error}"))
    })?;
    let quality_flags_json = serde_json::to_string(&result.quality_flags).map_err(|error| {
        GrapeError::message(format!("cannot serialize algorithm quality flags: {error}"))
    })?;
    ...
    .map_err(|error| {
        GrapeError::message(format!("cannot serialize algorithm provenance: {error}"))
    })?;
...
fn sleep_model_status_report(
    ...
    let can_show_final_score =
        can_show_personal_baseline && coverage_ready && input.trusted_grape_sleep_nights > 0;
    ...
    SleepModelStatusReport {
        ...
        valid_sleep_nights,
        trusted_grape_sleep_nights: input.trusted_grape_sleep_nights,
        ...
        nights_until_baseline,
        nights_until_grape_training: 7u32.saturating_sub(input.trusted_grape_sleep_nights),
        nights_until_training,
