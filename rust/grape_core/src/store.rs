...
impl GrapeStore {
    ...
    pub fn open_in_memory() -> GrapeResult<Self> {
    ...
    pub fn immediate_transaction<F, T>(&self, operation: F) -> GrapeResult<T>
    where
        F: FnOnce(&GrapeStore) -> GrapeResult<T>,
    {
    ...
    pub fn migrate(&self) -> GrapeResult<()> {
        self.conn.execute_batch(
            r#"
            PRAGMA foreign_keys = ON;

            CREATE TABLE IF NOT EXISTS grape_schema_migrations (
            ...
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (1);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (2);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (3);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (4);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (5);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (6);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (7);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (8);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (9);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (10);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (11);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (12);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (13);
            INSERT OR IGNORE INTO grape_schema_migrations(version) VALUES (14);
    ...
    pub fn schema_version(&self) -> GrapeResult<i64> {
        Ok(self
            .conn
    ...
    pub fn overnight_mirror_counts(&self, session_id: &str) -> GrapeResult<OvernightMirrorCounts> {
        ...
        Ok(OvernightMirrorCounts {
            schema: "grape.overnight-mirror-counts.v1".to_string(),
    ...
    fn ensure_overnight_mirror_tables(&self) -> GrapeResult<()> {
        self.conn.execute_batch(
            r#"
    ...
    fn insert_overnight_raw_notification(
        ...
        let payload = hex::decode(input.frame_hex).map_err(|error| {
            GrapeError::message(format!("frame_hex is not valid hexadecimal: {error}"))
        })?;
    ...
    pub fn insert_raw_evidence(&self, input: RawEvidenceInput<'_>) -> GrapeResult<bool> {
        ...
        match existing_sha256 {
            ...
            Some(_) => Err(GrapeError::message(format!(
                "raw evidence id {} already exists with a different checksum",
                input.evidence_id
            ))),
            None => Err(GrapeError::message(format!(
    ...
    pub fn insert_decoded_frame(&self, input: DecodedFrameInput<'_>) -> GrapeResult<bool> {
    ...
    pub fn start_capture_session(&self, input: CaptureSessionInput<'_>) -> GrapeResult<bool> {
        validate_required("session_id", input.session_id)?;
        validate_required("source", input.source)?;
        validate_required("device_model", input.device_model)?;
    ...
    pub fn finish_capture_session(
        ...
        self.capture_session(session_id)?
            .ok_or_else(|| GrapeError::message(format!("capture session {session_id} not found")))
    }

    pub fn capture_session(&self, session_id: &str) -> GrapeResult<Option<CaptureSessionRow>> {
        validate_required("session_id", session_id)?;
        self.conn
            .query_row(
                r#"
    ...
    pub fn capture_sessions_between(
        ...
        start_unix_ms: i64,
        end_unix_ms: i64,
    ) -> GrapeResult<Vec<CaptureSessionRow>> {
    ...
    pub fn insert_activity_session(&self, input: ActivitySessionInput<'_>) -> GrapeResult<bool> {
    ...
    pub fn update_activity_session(&self, input: ActivitySessionInput<'_>) -> GrapeResult<bool> {
        validate_activity_session_input(self, &input)?;
    ...
    pub fn delete_activity_session(&self, session_id: &str) -> GrapeResult<bool> {
        validate_required("session_id", session_id)?;
        let changed = self.conn.execute(
    ...
    pub fn activity_session(&self, session_id: &str) -> GrapeResult<Option<ActivitySessionRow>> {
        validate_required("session_id", session_id)?;
        self.conn
            .query_row(
                r#"
    ...
    ) -> GrapeResult<Vec<ActivitySessionRow>> {
    ...
    pub fn insert_activity_metric(&self, input: ActivityMetricInput<'_>) -> GrapeResult<bool> {
    ...
    fn insert_activity_metric_without_session_check(
        ...
        Err(GrapeError::message(format!(
            "activity metric {} insert was ignored but no existing row was found",
            input.metric_id
        )))
    }

    pub fn activity_metric(&self, metric_id: &str) -> GrapeResult<Option<ActivityMetricRow>> {
    ...
    ) -> GrapeResult<Vec<ActivityMetricRow>> {
    ...
    pub fn daily_activity_metric(
        &self,
        daily_metric_id: &str,
    ) -> GrapeResult<Option<DailyActivityMetricRow>> {
    ...
    pub fn daily_activity_metrics_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<DailyActivityMetricRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    ) -> GrapeResult<Option<HourlyActivityMetricRow>> {
    ...
    pub fn hourly_activity_metrics_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<HourlyActivityMetricRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    pub fn daily_recovery_metric(
        &self,
        daily_metric_id: &str,
    ) -> GrapeResult<Option<DailyRecoveryMetricRow>> {
        validate_required("daily_metric_id", daily_metric_id)?;
        self.conn
            .query_row(
                r#"
    ...
    pub fn daily_recovery_metrics_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<DailyRecoveryMetricRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    pub fn insert_metric_provenance(&self, input: MetricProvenanceInput<'_>) -> GrapeResult<bool> {
    ...
    pub fn upsert_metric_provenance(&self, input: MetricProvenanceInput<'_>) -> GrapeResult<bool> {
        validate_metric_provenance_input(self, &input)?;
        let changed = self.conn.execute(
            r#"
            INSERT INTO metric_provenance (
    ...
    pub fn metric_provenance(
        &self,
        provenance_id: &str,
    ) -> GrapeResult<Option<MetricProvenanceRow>> {
    ...
    pub fn metric_provenance_for_metric(
        ...
        metric_scope: &str,
        metric_id: &str,
    ) -> GrapeResult<Vec<MetricProvenanceRow>> {
    ...
    pub fn metric_debug_feature(
        &self,
        feature_id: &str,
    ) -> GrapeResult<Option<MetricDebugFeatureRow>> {
    ...
    pub fn metric_debug_features_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<MetricDebugFeatureRow>> {
    ...
    pub fn step_counter_sample(
        &self,
        sample_id: &str,
    ) -> GrapeResult<Option<StepCounterSampleRow>> {
    ...
    pub fn step_counter_samples_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<StepCounterSampleRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    pub fn insert_activity_interval(&self, input: ActivityIntervalInput<'_>) -> GrapeResult<bool> {
    ...
    pub fn activity_interval(&self, interval_id: &str) -> GrapeResult<Option<ActivityIntervalRow>> {
    ...
    pub fn activity_intervals_for_session(
        &self,
        activity_session_id: &str,
    ) -> GrapeResult<Vec<ActivityIntervalRow>> {
        validate_required("activity_session_id", activity_session_id)?;
        if self.activity_session(activity_session_id)?.is_none() {
            return Err(GrapeError::message(format!(
                "activity session {} not found",
    ...
    pub fn insert_activity_label(&self, input: ActivityLabelInput<'_>) -> GrapeResult<bool> {
    ...
    pub fn external_sleep_session(
        &self,
        sleep_id: &str,
    ) -> GrapeResult<Option<ExternalSleepSessionRow>> {
    ...
    pub fn external_sleep_sessions_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<ExternalSleepSessionRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    pub fn external_sleep_stage(
        &self,
        stage_id: &str,
    ) -> GrapeResult<Option<ExternalSleepStageRow>> {
    ...
    pub fn external_sleep_stages_for_session(
        &self,
        sleep_id: &str,
    ) -> GrapeResult<Vec<ExternalSleepStageRow>> {
        validate_required("sleep_id", sleep_id)?;
        let mut statement = self.conn.prepare(
            r#"
            SELECT
    ...
    pub fn sleep_correction_label(
        &self,
        label_id: &str,
    ) -> GrapeResult<Option<SleepCorrectionLabelRow>> {
    ...
    pub fn sleep_correction_labels_between(
        ...
        start_time_unix_ms: i64,
        end_time_unix_ms: i64,
    ) -> GrapeResult<Vec<SleepCorrectionLabelRow>> {
        validate_non_negative("start_time_unix_ms", start_time_unix_ms)?;
        validate_non_negative("end_time_unix_ms", end_time_unix_ms)?;
        validate_window_order(start_time_unix_ms, end_time_unix_ms)?;
        let mut statement = self.conn.prepare(
    ...
    pub fn activity_label(&self, label_id: &str) -> GrapeResult<Option<ActivityLabelRow>> {
        validate_required("label_id", label_id)?;
        self.conn
            .query_row(
                r#"
    ...
    pub fn activity_labels_for_session(
        &self,
        activity_session_id: &str,
    ) -> GrapeResult<Vec<ActivityLabelRow>> {
        validate_required("activity_session_id", activity_session_id)?;
        if self.activity_session(activity_session_id)?.is_none() {
            return Err(GrapeError::message(format!(
                "activity session {} not found",
    ...
    pub fn activity_labels_by_type(&self, label_type: &str) -> GrapeResult<Vec<ActivityLabelRow>> {
    ...
    pub fn raw_evidence(&self, evidence_id: &str) -> GrapeResult<Option<RawEvidenceRow>> {
        self.conn
            .query_row(
                r#"
                SELECT
    ...
    pub fn raw_evidence_between(&self, start: &str, end: &str) -> GrapeResult<Vec<RawEvidenceRow>> {
    ...
    pub fn raw_evidence_payload_bytes(&self) -> GrapeResult<i64> {
    ...
    pub fn compact_raw_evidence_payloads_to_limit(
        &self,
        limit_bytes: i64,
    ) -> GrapeResult<RawEvidencePayloadRetentionReport> {
    ...
    ) -> GrapeResult<Vec<DecodedFrameRow>> {
        validate_required("start", start)?;
        validate_required("end", end)?;
    ...
    pub fn decoded_frame(&self, frame_id: &str) -> GrapeResult<Option<DecodedFrameRow>> {
    ...
    pub fn algorithm_definition(
        ...
        algorithm_id: &str,
        version: &str,
    ) -> GrapeResult<Option<AlgorithmDefinitionRecord>> {
        self.conn
            .query_row(
                r#"
                SELECT
    ...
    pub fn algorithm_preference(
        ...
        scope: &str,
        metric_family: &str,
    ) -> GrapeResult<Option<AlgorithmPreferenceRecord>> {
    ...
    pub fn algorithm_preferences(
        &self,
        scope: Option<&str>,
    ) -> GrapeResult<Vec<AlgorithmPreferenceRecord>> {
    ...
    pub fn insert_algorithm_run(&self, run: &AlgorithmRunRecord) -> GrapeResult<bool> {
    ...
    fn insert_metric_rows_for_algorithm_run(&self, run: &AlgorithmRunRecord) -> GrapeResult<()> {
        let definition = self
        ...
        let output: Value = serde_json::from_str(&run.output_json).map_err(|error| {
            GrapeError::message(format!("output_json is not valid JSON: {error}"))
        })?;
    ...
    pub fn algorithm_run(&self, run_id: &str) -> GrapeResult<Option<AlgorithmRunRecord>> {
        self.conn
            .query_row(
                r#"
                SELECT
    ...
    ) -> GrapeResult<Vec<AlgorithmRunRecord>> {
        validate_required("start", start)?;
        validate_required("end", end)?;
    ...
    pub fn metric_values_for_run(&self, run_id: &str) -> GrapeResult<Vec<MetricValueRecord>> {
    ...
    pub fn metric_components_for_run(
        &self,
        run_id: &str,
    ) -> GrapeResult<Vec<MetricComponentRecord>> {
        validate_required("run_id", run_id)?;
        let mut statement = self.conn.prepare(
            r#"
            SELECT
    ...
    pub fn insert_calibration_run(&self, run: &CalibrationRunRecord) -> GrapeResult<bool> {
    ...
    ) -> GrapeResult<Option<CalibrationRunRecord>> {
        self.conn
            .query_row(
                r#"
                SELECT
    ...
    ) -> GrapeResult<Vec<CalibrationRunRecord>> {
        validate_required("start", start)?;
        validate_required("end", end)?;
    ...
    pub fn insert_calibration_label(&self, input: CalibrationLabelInput<'_>) -> GrapeResult<bool> {
        ...
        if !input.value.is_finite() {
            return Err(GrapeError::message("value must be finite"));
        }
        ...
        let parsed_provenance: serde_json::Value = serde_json::from_str(input.provenance_json)
            .map_err(|error| {
                GrapeError::message(format!("provenance_json must be valid JSON: {error}"))
            })?;
        if parsed_provenance == serde_json::json!({}) {
            return Err(GrapeError::message("provenance_json must not be empty"));
        }
    ...
    pub fn calibration_label(&self, label_id: &str) -> GrapeResult<Option<CalibrationLabelRow>> {
        validate_required("label_id", label_id)?;
        self.conn
            .query_row(
                r#"
    ...
    ) -> GrapeResult<Vec<CalibrationLabelRow>> {
        validate_required("start", start)?;
        validate_required("end", end)?;
        let mut statement = self.conn.prepare(
            r#"
    ...
    pub fn command_validation_record(
        &self,
        command: &str,
    ) -> GrapeResult<Option<CommandValidationRecord>> {
    ...
    pub fn command_validation_records(&self) -> GrapeResult<Vec<CommandValidationRecord>> {
        let mut statement = self.conn.prepare(
            r#"
            SELECT command, risk_gate, direct_send_ready, report_json
            FROM command_validation_records
    ...
    pub fn insert_debug_session(&self, session: &DebugSessionRow) -> GrapeResult<bool> {
    ...
    pub fn debug_session(&self, session_id: &str) -> GrapeResult<Option<DebugSessionRow>> {
        validate_required("session_id", session_id)?;
        self.conn
            .query_row(
                r#"
    ...
    pub fn debug_sessions_between(
        ...
        start_unix_ms: i64,
        end_unix_ms: i64,
    ) -> GrapeResult<Vec<DebugSessionRow>> {
        validate_non_negative("start_unix_ms", start_unix_ms)?;
    ...
    pub fn insert_debug_command(&self, command: &DebugCommandRow) -> GrapeResult<bool> {
    ...
    pub fn debug_command(&self, command_id: &str) -> GrapeResult<Option<DebugCommandRow>> {
    ...
    pub fn debug_commands_for_session(
        &self,
        session_id: &str,
    ) -> GrapeResult<Vec<DebugCommandRow>> {
        validate_required("session_id", session_id)?;
        let mut statement = self.conn.prepare(
            r#"
            SELECT
    ...
    pub fn next_debug_event_sequence(&self, session_id: &str) -> GrapeResult<i64> {
        validate_required("session_id", session_id)?;
    ...
    pub fn insert_debug_event(&self, event: &DebugEventRow) -> GrapeResult<bool> {
    ...
    pub fn debug_events_for_session(&self, session_id: &str) -> GrapeResult<Vec<DebugEventRow>> {
        validate_required("session_id", session_id)?;
        let mut statement = self.conn.prepare(
            r#"
            SELECT
    ...
    pub fn debug_events_after_sequence(
        ...
        let limit = i64::try_from(limit.unwrap_or(1000))
            .map_err(|_| GrapeError::message("limit is too large"))?;
    ...
    pub fn table_count(&self, table: &str) -> GrapeResult<i64> {
        if !is_known_table(table) {
            return Err(GrapeError::message(format!("unknown table: {table}")));
        }
        let query = format!("SELECT COUNT(*) FROM {table}");
        Ok(self.conn.query_row(&query, [], |row| row.get(0))?)
    }

    pub fn table_columns(&self, table: &str) -> GrapeResult<BTreeSet<String>> {
        if !is_known_table(table) {
            return Err(GrapeError::message(format!("unknown table: {table}")));
        }
    ...
    pub fn foreign_keys_enabled(&self) -> GrapeResult<bool> {
    ...
    pub fn integrity_check(&self) -> GrapeResult<String> {
        self.conn
...
impl GrapeStore {
    fn ensure_raw_evidence_columns(&self) -> GrapeResult<()> {
    ...
    fn ensure_decoded_frame_columns(&self) -> GrapeResult<()> {
    ...
    fn ensure_algorithm_definition_columns(&self) -> GrapeResult<()> {
    ...
    fn ensure_daily_activity_metric_multi_row_source_kind(&self) -> GrapeResult<()> {
    ...
    fn daily_activity_metrics_has_source_kind_unique_constraint(&self) -> GrapeResult<bool> {
        self.table_has_source_kind_unique_constraint("daily_activity_metrics")
    }

    fn ensure_daily_recovery_metric_multi_row_source_kind(&self) -> GrapeResult<()> {
    ...
    fn daily_recovery_metrics_has_source_kind_unique_constraint(&self) -> GrapeResult<bool> {
        self.table_has_source_kind_unique_constraint("daily_recovery_metrics")
    }

    fn table_has_source_kind_unique_constraint(&self, table: &str) -> GrapeResult<bool> {
    ...
    fn ensure_step_counter_sample_columns(&self) -> GrapeResult<()> {
    ...
    fn table_columns_unchecked(&self, table: &str) -> GrapeResult<BTreeSet<String>> {
    ...
    fn index_columns_unchecked(&self, index_name: &str) -> GrapeResult<Vec<String>> {
...
fn validate_required(name: &str, value: &str) -> GrapeResult<()> {
    if value.trim().is_empty() {
        Err(GrapeError::message(format!("{name} is required")))
    } else {
        Ok(())
    }
}

fn validate_optional_required(name: &str, value: Option<&str>) -> GrapeResult<()> {
...
fn validate_json(name: &str, value: &str) -> GrapeResult<()> {
    serde_json::from_str::<serde_json::Value>(value)
        .map_err(|error| GrapeError::message(format!("{name} must be valid JSON: {error}")))?;
    Ok(())
}

fn validate_command_report_json(record: &CommandValidationRecord) -> GrapeResult<()> {
    let parsed = serde_json::from_str::<serde_json::Value>(&record.report_json)
        .map_err(|error| GrapeError::message(format!("report_json must be valid JSON: {error}")))?;
    let Some(report_command) = parsed.get("command").and_then(serde_json::Value::as_str) else {
        return Err(GrapeError::message("report_json must contain command"));
    };
    ...
    let Some(report_risk_gate) = parsed.get("risk_gate").and_then(serde_json::Value::as_str) else {
        return Err(GrapeError::message("report_json must contain risk_gate"));
    };
...
fn validate_json_object(name: &str, value: &str) -> GrapeResult<()> {
    let parsed = serde_json::from_str::<serde_json::Value>(value)
        .map_err(|error| GrapeError::message(format!("{name} must be valid JSON: {error}")))?;
    if !parsed.is_object() {
        return Err(GrapeError::message(format!("{name} must be a JSON object")));
    }
    Ok(())
}

fn validate_no_official_whoop_label_marker(name: &str, value: &str) -> GrapeResult<()> {
...
fn validate_no_official_whoop_label_text(name: &str, value: &str) -> GrapeResult<()> {
...
fn validate_no_platform_metric_source_marker(name: &str, value: &str) -> GrapeResult<()> {
    let parsed = serde_json::from_str::<Value>(value)
        .map_err(|error| GrapeError::message(format!("{name} must be valid JSON: {error}")))?;
...
fn validate_no_platform_metric_source_text(name: &str, value: &str) -> GrapeResult<()> {
...
fn validate_external_sleep_stage_summary_json(value: &str) -> GrapeResult<()> {
    let parsed = serde_json::from_str::<serde_json::Value>(value).map_err(|error| {
        GrapeError::message(format!("stage_summary_json must be valid JSON: {error}"))
    })?;
...
fn validate_external_sleep_stage_summary_key(stage: &str) -> GrapeResult<()> {
...
fn validate_non_negative(name: &str, value: i64) -> GrapeResult<()> {
    if value < 0 {
        Err(GrapeError::message(format!("{name} must be non-negative")))
    } else {
        Ok(())
    }
}

fn validate_optional_non_negative_i64(name: &str, value: Option<i64>) -> GrapeResult<()> {
    if let Some(value) = value {
...
fn validate_optional_finite_f64(name: &str, value: Option<f64>) -> GrapeResult<()> {
    if let Some(value) = value {
        if !value.is_finite() {
            return Err(GrapeError::message(format!("{name} must be finite")));
        }
    }
    Ok(())
}

fn validate_optional_non_negative_f64(name: &str, value: Option<f64>) -> GrapeResult<()> {
    if let Some(value) = value {
...
fn validate_positive(name: &str, value: i64) -> GrapeResult<()> {
    if value <= 0 {
        Err(GrapeError::message(format!("{name} must be positive")))
    } else {
        Ok(())
    }
}

fn validate_window_order(start_time_unix_ms: i64, end_time_unix_ms: i64) -> GrapeResult<()> {
    if end_time_unix_ms <= start_time_unix_ms {
        Err(GrapeError::message(
...
fn validate_allowed(name: &str, value: &str, allowed: &[&str]) -> GrapeResult<()> {
...
fn validate_activity_type(activity_type: &str) -> GrapeResult<()> {
    validate_allowed("activity_type", activity_type, &ALLOWED_ACTIVITY_TYPES)
}

fn validate_sync_status(sync_status: &str) -> GrapeResult<()> {
    validate_allowed("sync_status", sync_status, &ALLOWED_ACTIVITY_SYNC_STATUSES)
}

fn validate_activity_detection_method(detection_method: &str) -> GrapeResult<()> {
    validate_allowed(
        "detection_method",
        detection_method,
...
fn validate_activity_interval_type(interval_type: &str) -> GrapeResult<()> {
    validate_allowed(
        "interval_type",
        interval_type,
...
fn validate_activity_label_type(label_type: &str) -> GrapeResult<()> {
    validate_allowed("label_type", label_type, &ALLOWED_ACTIVITY_LABEL_TYPES)
}

fn validate_activity_metric_unit(unit: &str) -> GrapeResult<()> {
    validate_allowed("unit", unit, &ALLOWED_ACTIVITY_METRIC_UNITS)
}

fn validate_metric_source_kind(source_kind: &str) -> GrapeResult<()> {
    validate_allowed("source_kind", source_kind, &ALLOWED_METRIC_SOURCE_KINDS)
}

fn validate_metric_provenance_scope(metric_scope: &str) -> GrapeResult<()> {
    validate_allowed(
        "metric_scope",
        metric_scope,
...
fn validate_external_sleep_platform(platform: &str) -> GrapeResult<()> {
    validate_allowed("platform", platform, &ALLOWED_EXTERNAL_SLEEP_PLATFORMS)
}

fn validate_external_sleep_stage_kind(stage_kind: &str) -> GrapeResult<()> {
    validate_allowed(
        "stage_kind",
        stage_kind,
...
fn validate_sleep_correction_label_type(label_type: &str) -> GrapeResult<()> {
    validate_allowed(
        "label_type",
        label_type,
...
fn validate_confidence(name: &str, confidence: f64) -> GrapeResult<()> {
...
fn validate_unavailable_metric_confidence(source_kind: &str, confidence: f64) -> GrapeResult<()> {
...
fn validate_daily_activity_metric_input(input: &DailyActivityMetricInput<'_>) -> GrapeResult<()> {
...
fn validate_hourly_activity_metric_input(input: &HourlyActivityMetricInput<'_>) -> GrapeResult<()> {
...
fn validate_daily_recovery_metric_input(input: &DailyRecoveryMetricInput<'_>) -> GrapeResult<()> {
    validate_required("daily_metric_id", input.daily_metric_id)?;
    validate_required("date_key", input.date_key)?;
    validate_required("timezone", input.timezone)?;
    validate_non_negative("start_time_unix_ms", input.start_time_unix_ms)?;
...
fn validate_metric_debug_feature_input(input: &MetricDebugFeatureInput<'_>) -> GrapeResult<()> {
...
fn validate_step_counter_sample_input(input: &StepCounterSampleInput<'_>) -> GrapeResult<()> {
...
fn validate_external_sleep_session_input(input: &ExternalSleepSessionInput<'_>) -> GrapeResult<()> {
...
fn validate_sleep_correction_label_input(input: &SleepCorrectionLabelInput<'_>) -> GrapeResult<()> {
    validate_required("label_id", input.label_id)?;
