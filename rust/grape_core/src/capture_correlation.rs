...
use crate::{
    ...
    store::{DecodedFrameRow, GrapeStore, RawEvidenceRow},
};

pub const CAPTURE_CORRELATION_REPORT_SCHEMA: &str = "grape.capture-correlation-report.v1";
...
pub fn run_capture_correlation(
    ...
    CaptureCorrelationReport {
        ...
        generated_by: "grape-capture-correlation".to_string(),
...
pub fn run_capture_correlation_for_store(
    ...
    options: CaptureCorrelationOptions,
) -> GrapeResult<CaptureCorrelationReport> {
